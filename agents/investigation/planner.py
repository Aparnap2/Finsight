...
_SYSTEM_PROMPT = (
    ...
    "evidence synthesis. "
    "Tenant isolation: tenant_id and actor are server-derived and immutable — "
    "never select, invent, or change tenant; evidence_required must be a "
    "non-empty subset of the provided evidence_ids (tenant-scoped, verified); "
    "citing any id outside that set will be rejected. Do not attempt to "
    "access another tenant's case, evidence, or credentials, or to expand the "
    "allowlist. "
